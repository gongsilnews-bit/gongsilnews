    ...
    <div style={{ flex: 1, overflowY: "auto", height: "100%", background: pageBg }}>
      <div style={{ maxWidth: leftSidebarMode === "ai_chat" ? 1760 : 1400, margin: "0 auto", padding: "10px 24px 24px 24px", display: "flex", gap: 20, alignItems: "flex-start", width: "100%", transition: "max-width 0.25s ease" }}>
        ...
        <aside style={{
          ...
          {leftSidebarMode === "tools" ? (
            /* ── 기본 글쓰기도구 (220px) ── */
            <div style={{ background: cardBg, borderRadius: 12, border: `1px solid ${border}`, padding: "20px 16px" }}>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: textPrimary, margin: "0 0 16px 0" }}>글쓰기도구</h3>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 4, marginBottom: 20 }}>
                ...
                <button onClick={openPhotoModal} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, padding: "12px 4px", border: "none", background: "none", cursor: "pointer", borderRadius: 8 }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 600, color: "#3b82f6" }}>사진</span>
                </button>
                {/* 영상 */}
                <button onClick={openVideoModal} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, padding: "12px 4px", border: "none", background: "none", cursor: "pointer", borderRadius: 8 }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 600, color: "#ef4444" }}>영상</span>
                </button>
                {/* 포토DB */}
                <button onClick={openPhotoDbModal} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, padding: "12px 4px", border: "none", background: "none", cursor: "pointer", borderRadius: 8 }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 600, color: textSecondary }}>포토DB</span>
                </button>
              </div>
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          <div style={{ background: cardBg, borderRadius: 12, border: `1px solid ${border}`, padding: "32px 36px" }}>
            ...
            {/* ── ⚡ 모듈화 분리된 기사 하단 배너 광고 설정 컴포넌트 ── */}
            <ArticleAdSettingSlot
              writeAdType={writeAdType}
              setWriteAdType={setWriteAdType}
              writeAdMode={writeAdMode}
              setWriteAdMode={setWriteAdMode}
              writeAdBannerId={writeAdBannerId}
              setWriteAdBannerId={setWriteAdBannerId}
              writeAdBannerName={writeAdBannerName}
              setWriteAdBannerName={setWriteAdBannerName}
              writeAdFile={writeAdFile}
              setWriteAdFile={setWriteAdFile}
              writeAdLinkUrl={writeAdLinkUrl}
              setWriteAdLinkUrl={setWriteAdLinkUrl}
              writeAdPreview={writeAdPreview}
              setWriteAdPreview={setWriteAdPreview}
              writeAdStartDate={writeAdStartDate}
              setWriteAdStartDate={setWriteAdStartDate}
              writeAdEndDate={writeAdEndDate}
              setWriteAdEndDate={setWriteAdEndDate}
              authorBanners={authorBanners}
              setAuthorBanners={setAuthorBanners}
              loadArticleId={loadArticleId}
              memberAuthorId={memberAuthorId}
      ...
      {/* ── ⚡ 모듈화 분리된 사진/동영상 추가 및 편집 모달 ── */}
      <ArticlePhotoModals
        showVideoModal={showVideoModal}
        setShowVideoModal={setShowVideoModal}
        modalVideoUrl={modalVideoUrl}
        setModalVideoUrl={setModalVideoUrl}
        modalVideoShorts={modalVideoShorts}
        setModalVideoShorts={setModalVideoShorts}
        handleVideoModalConfirm={handleVideoModalConfirm}
        ...
        modalInsertMode={modalInsertMode}
        setModalInsertMode={setModalInsertMode}
        modalAlign={modalAlign}
        setModalAlign={setModalAlign}
        modalWatermark={modalWatermark}
        setModalWatermark={setModalWatermark}
        modalCaption={modalCaption}
        setModalCaption={setModalCaption}
        modalCaptionAlign={modalCaptionAlign}
        setModalCaptionAlign={setModalCaptionAlign}
        mosaicMode={mosaicMode}
        setMosaicMode={setMosaicMode}
        mosaicRect={mosaicRect}
        setMosaicRect={setMosaicRect}
        modalFileRef={modalFileRef}
        handleModalFileSelect={handleModalFileSelect}
        handleMosaicPointerDown={handleMosaicPointerDown}
        handleMosaicPointerMove={handleMosaicPointerMove}
        handleMosaicPointerUp={handleMosaicPointerUp}
        resetMosaic={resetMosaic}
        handlePhotoModalConfirm={handlePhotoModalConfirm}

        showEditModal={showEditModal}
        setShowEditModal={setShowEditModal}
        editPhotoIdx={editPhotoIdx}
        photoFiles={photoFiles}
        editSize={editSize}
        setEditSize={setEditSize}
        editInsertMode={editInsertMode}
        setEditInsertMode={setEditInsertMode}
        editAlign={editAlign}
        setEditAlign={setEditAlign}
        editCaption={editCaption}
        setEditCaption={setEditCaption}
        editCaptionAlign={editCaptionAlign}
        setEditCaptionAlign={setEditCaptionAlign}
        handleEditPhotoConfirm={handleEditPhotoConfirm}
        ...
        editVideoCaption={editVideoCaption}
        setEditVideoCaption={setEditVideoCaption}
        handleEditVideoConfirm={handleEditVideoConfirm}
      ...
      {/* ── ⚡ 모듈화 분리된 포토DB 검색/보관 라이브러리 모달 ── */}
      <ArticlePhotoLibraryDrawer
        isOpen={showPhotoDbModal}
        onClose={() => setShowPhotoDbModal(false)}
        onSelectPhoto={(file) => handlePhotoSelect([file])}
        authorId={memberAuthorId || currentUserId}
        border={border}
        textPrimary={textPrimary}
        textSecondary={textSecondary}
        textMuted={textMuted}
