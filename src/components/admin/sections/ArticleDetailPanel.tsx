      ...
      <div className="adp-main">
        ...
        <div className={`adp-frame adp-${device}`}>
          ...
          <div className="adp-toolbar">
            ...
            <button className="adp-toolbar-btn" onClick={() => { const origin = window.location.origin.includes('localhost') ? 'https://www.gongsilnews.com' : window.location.origin; const url = `${origin}${articleUrl}`; navigator.clipboard?.writeText(url).then(() => alert('URL 복사됨')); }}>🔗 주소복사</button>
