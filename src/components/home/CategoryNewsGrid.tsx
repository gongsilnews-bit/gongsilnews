...
export default function CategoryNewsGrid({ allNewsArticles = [], mapArticles = [], issueRightBanners, middleIssueBanners }: CategoryNewsGridProps) {
  ...
  const allMarketing = allNewsArticles.filter(a => a.section1 === "AI중개실무" || a.section1 === "AI마케팅");
  const allEconomy = allNewsArticles.filter(a => a.section1 === "정책시장" || a.section1 === "부동산·경제");
