...
export default function HeroMapSection({ initialVacancies }: { initialVacancies?: any[] }) {
  ...
  useEffect(() => {
    ...
    const clusterer = new kakao.maps.MarkerClusterer({
      ...
      calculator: [10, 30, 50],
      styles: [
        { width: "44px", height: "44px", background: "#3e6bb5", borderRadius: "50%", color: "#fff", textAlign: "center", lineHeight: "38px", fontSize: "15px", font_weight: "bold", border: "3px solid rgba(255,255,255,0.8)", boxShadow: "0 2px 8px rgba(0,0,0,0.3)" },
        { width: "54px", height: "54px", background: "#2a5499", borderRadius: "50%", color: "#fff", textAlign: "center", lineHeight: "48px", fontSize: "17px", font_weight: "bold", border: "3px solid rgba(255,255,255,0.8)", boxShadow: "0 2px 8px rgba(0,0,0,0.3)" },
        { width: "64px", height: "64px", background: "#1a4282", borderRadius: "50%", color: "#fff", textAlign: "center", lineHeight: "58px", fontSize: "19px", font_weight: "bold", border: "3px solid rgba(255,255,255,0.8)", boxShadow: "0 2px 8px rgba(0,0,0,0.3)" },
      ],
    });
        ...
        clusters.forEach(cluster => {
          ...
          if (isMatch) {
              ...
              if (overlay && overlay.style) {
                  ...
                  overlay.style.border = '2px solid #1a4282';
