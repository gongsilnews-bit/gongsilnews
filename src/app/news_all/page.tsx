...
const dummyArticles = [
  {
    id: 1,
    title: '대법원, 신반포2차 재건축 상가 분쟁에 마침표..."조합원 전원 동의 불필요"',
    desc: '대법원, 상가 산정 비율 관련 소송서 조합 승소 판결...\'전원 동의\' 족쇄 풀었다 신반포2차, 1572가구에서 2056가구 대단지로 탈바꿈...사업 추진에 청신호 은...',
    section1: '뉴스/칼럼',
    section2: '부동산·주식·재테크',
    date: '2026. 04. 05. 오후 09:20',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 2,
    title: '서울 아파트 공시가 18.7% 급등... "한강벨트" 보유세 50% 이상 오를 듯',
    desc: '서울 공동주택 공시가 \'어깨\' 단계에서 18.7% 급등...건전 공동주택(3.7%) 3배 수준, 특히 압(특히)여의도 풀러...',
    section1: '뉴스/칼럼',
    section2: '부동산·주식·재테크',
    date: '2026. 04. 05. 오후 09:18',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 3,
    title: '이란, "공격 중단" 하루 만에 번복... 중동 확전 위기 최고조',
    desc: '이란 대통령의, 핵무기 소설 용의 불안감 마음 부침에 중교 역심리 반발 수...핵능 3000 여색 시별리안지점되지마 중발통 확성되어 길 민',
    section1: '뉴스/칼럼',
    section2: '정치·경제·사회',
    date: '2026. 04. 05. 오후 09:17',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 4,
    title: '중동 지정학적 리스크 격화, "고유가-주가 하락" 한국 경제 어떻게 되나',
    desc: '중동 분쟁 심화로 국제 유가 급등 전망 가능, 내년 물가기 둔화 허위연체 모소 압작 신뢰격 하락세, 내각 응식 허...',
    section1: '뉴스/칼럼',
    section2: '정치·경제·사회',
    date: '2026. 04. 05. 오후 09:16',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 5,
    title: '한국 대표팀, 3월 14일 미국 마이애미서 8강 격돌',
    desc: '한국, 3월 14일 미국 마이애미에서 8강전 및 총리...첫 한의 기회인 문원한건 대분 위리, 칸사 사건...',
    section1: '뉴스/칼럼',
    section2: '스포츠·연예·Car',
    date: '2026. 04. 05. 오후 09:15',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 6,
    title: '언제 어디서나 진료!... 상시 비대면 진료 공식 허용으로 의료 패러다임 전환',
    desc: '의료법 개정 통해 비대면 진료 상시화... 감염병 위기 단계 무관하게 법적 근거 마련 재진 환자 중심 원칙 속 취약계층 예외 확대 및 야간·휴일 진료 접근성 향상 디지털 헬스케어 산업 급성장 기대 속 약 배송 및 수가 체...',
    section1: '뉴스/칼럼',
    section2: '건강·헬스',
    date: '2026. 04. 05. 오후 09:13',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 7,
    title: '"내 취향 맞춤형 AI 가이드와 함께"... 북한산 \'K-등산\', 스마트 관광으로 진화',
    desc: '편리한 대중교통과 장비 대여 넘어 \'스마트 관광 서비스\' 본격 도입 및 확산 개인별 체력과 취향 분석해 최적의 등산 코스 및 하산 후 맛집까지 AI가 추천 디지털 기술 결합된 \'K-등산\' 콘텐츠로 외국인 관광객 만족도와 편의성 ...',
    section1: '뉴스/칼럼',
    section2: '여행·맛집',
    date: '2026. 04. 05. 오후 09:12',
    reporter: '김미숙',
    isVideo: false,
  },
  {
    id: 8,
    title: '"사망 전 10년 기록 다 본다"... 국세청 상속세 정밀 타격 포인트 7가지',
    desc: '사망 전 10년치 계좌이체 및 가족 계좌 전액 변동 집중 추적 최근 1~2년 내 인출된 수천만 원대 현금, 영수증 없으면 상속재산 간주 부동산 평가액 및 가족 간 채무 공제 시 실질적인 증빙 서류 필수',
    section1: '뉴스/칼럼',
    section2: '세무·법률',
    date: '2026. 04. 05. 오후 09:09',
    reporter: '김미숙',
    isVideo: true,
  },
  {
    id: 9,
    title: '부모님 자산 형태에 따른 세무 가이드 현금 있다면 \'증방\' 필수, 부동산만 있다면 \'채무\'로 인정받아야',
    desc: '"부모님 병원비, 그냥 내면 손해?"... 상속세 줄이는 \'증빙의 기술\' 현금 있으면 \'이체 메모\', 부동산뿐이면 \'차용 증... 자녀 대납금 \'채무\' 인정받아야 효도 비용 2억이 상속 재산 2억 공제로... "영수증 하나가 수천만 원 아낀다"',
    section1: '뉴스/칼럼',
    section2: '세무·법률',
    date: '2026. 04. 05. 오후 09:08',
    reporter: '김미숙',
    isVideo: true,
  },
  {
    id: 10,
    title: '"올림픽 아는지도 몰란다"...월러 노의 영성, 한국에선 \'무관심적 칼럭\'',
    desc: '세계 시건대 종가 걸도적 스단 부재에 그불 것 를 건의로 검회 한안 워...',
    section1: '뉴스/칼럼',
    section2: 'IT·가전·가구',
    date: '2026. 04. 05. 오후 09:05',
    reporter: '김미숙',
    isVideo: false,
  },
];
