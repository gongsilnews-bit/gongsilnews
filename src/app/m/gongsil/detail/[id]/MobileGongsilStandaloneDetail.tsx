...
import { getCleanAddrText, formatAreaWithPy, getMaskedAddress, getJitteredCoords } from "@/app/(map)/gongsil/gongsilHelpers";
...
export default function MobileGongsilStandaloneDetail({
  ...
  const [mobileRoadviewOpen, setMobileRoadviewOpen] = useState(false);
