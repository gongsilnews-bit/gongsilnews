...
export default function MobileTermsPage() {
  ...
  const h2Style: React.CSSProperties = { fontSize: 16, fontWeight: 800, color: "#111", marginBottom: 12, paddingBottom: 8, borderBottom: "1.5px solid #111" };
  const pStyle: React.CSSProperties = { fontSize: 13, lineHeight: 1.8, color: "#444", marginBottom: 10, wordBreak: "keep-all" };
  const olStyle: React.CSSProperties = { ...pStyle, paddingLeft: 20 };

  return (
    <div style={{ backgroundColor: "#fff", minHeight: "100vh" }}>
      {/* ── 심플 모바일 상단 헤더 ── */}
      <header style={{ display: "flex", alignItems: "center", padding: "0 16px", height: "56px", borderBottom: "1px solid #eee", position: "sticky", top: 0, background: "#fff", zIndex: 10 }}>
        ...
        <h1 style={{ fontSize: "17px", fontWeight: 800, margin: 0 }}>이용약관</h1>
      </header>

      {/* ── 약관 내용 본문 ── */}
      <div style={{ padding: "24px 16px 60px", fontFamily: "'Pretendard', 'Malgun Gothic', sans-serif" }}>
        
        <div style={{ marginBottom: 24 }}>
          <h1 style={{ fontSize: 24, fontWeight: 900, color: "#111", margin: "0 0 8px", letterSpacing: -1 }}>이용약관</h1>
          <p style={{ fontSize: 12, color: "#888", margin: 0 }}>시행일: 2026년 1월 1일 | 최종 수정일: 2026년 4월 1일</p>
        </div>

        {/* 제1장 총칙 */}
        <div style={{ background: "#f0f4ff", borderRadius: 8, padding: "12px 16px", marginBottom: 24, fontSize: 14, fontWeight: 700, color: "#1e56a0" }}>제1장 총칙</div>

        <div style={sectionStyle}>
          <h2 style={h2Style}>제1조 (목적)</h2>
          <p style={pStyle}>
            본 약관은 (주)공실뉴스(이하 &quot;회사&quot;)가 운영하는 인터넷 사이트 &quot;공실뉴스&quot;(https://gongsil.net, 이하 &quot;사이트&quot;)에서 제공하는 부동산 정보 서비스, 공실·공실광고 중개망 서비스, 뉴스 콘텐츠 서비스 및 기타 관련 서비스(이하 &quot;서비스&quot;)의 이용 조건 및 절차에 관한 사항을 규정함을 목적으로 합니다.
          </p>
        </div>
        ...
        <div style={sectionStyle}>
          ...
          <ol style={olStyle}>
            <li>&quot;서비스&quot;란 회사가 사이트를 통해 이용자에게 제공하는 부동산 뉴스, 공실 열람, 공실광고 등록, 공동중개, 포인트 거래, 자료실, 특강 등 일체의 서비스를 말합니다.</li>
            <li>&quot;이용자&quot;란 사이트에 접속하여 본 약관에 따라 서비스를 이용하는 회원 및 비회원을 말합니다.</li>
            <li>&quot;회원&quot;이란 사이트에 회원가입을 한 자로서, 회사가 제공하는 서비스를 이용할 수 있는 자를 말합니다.</li>
            <li>&quot;공인중개사 회원&quot;(이하 &quot;부동산 회원&quot;)이란 공인중개사 자격을 보유하고 별도의 인증 절차를 거쳐 공실광고 등록 및 공동중개 서비스를 이용하는 회원을 말합니다.</li>
        ...
        {/* 제2장 회원가입 */}
        <div style={{ background: "#f0f4ff", borderRadius: 8, padding: "12px 16px", marginBottom: 24, fontSize: 14, fontWeight: 700, color: "#1e56a0" }}>제2장 서비스 이용 계약</div>
        ...
        <div style={sectionStyle}>
          ...
          <ol style={olStyle}>
            ...
            <li>공실·공실광고 검색 및 열람 서비스 (공실열람, 지도 기반 탐색)</li>
            <li>공실·공실광고 등록 및 공동중개 서비스</li>
        ...
        {/* 제3장 */}
        <div style={{ background: "#f0f4ff", borderRadius: 8, padding: "12px 16px", marginBottom: 24, fontSize: 14, fontWeight: 700, color: "#1e56a0" }}>제3장 서비스 이용</div>
        ...
        <div style={sectionStyle}>
          ...
          <ol style={olStyle}>
            <li>허위 공실광고 정보를 등록하거나 타인의 정보를 도용하는 행위</li>
        ...
        {/* 제4장 */}
        <div style={{ background: "#f0f4ff", borderRadius: 8, padding: "12px 16px", marginBottom: 24, fontSize: 14, fontWeight: 700, color: "#1e56a0" }}>제4장 포인트 및 결제</div>
        ...
        {/* 제5장 */}
        <div style={{ background: "#f0f4ff", borderRadius: 8, padding: "12px 16px", marginBottom: 24, fontSize: 14, fontWeight: 700, color: "#1e56a0" }}>제5장 기타</div>
        ...
        <div style={sectionStyle}>
          ...
          <ol style={olStyle}>
            ...
            <li>공실광고 정보의 정확성은 해당 공실광고을 등록한 이용자(부동산 회원 등)에게 있으며, 회사는 공실광고 정보의 사실 여부에 대해 보증하지 않습니다.</li>
          </ol>
        </div>
