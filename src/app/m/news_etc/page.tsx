...
export default async function MobileNewsPage({
  ...
  const filters: any = { status: "APPROVED", limit: 30, section1: "?ºÏù¥?Ñ¬∑Ïò§?ºÎãà?? };
  ...
  return <MobileNewsClientWrapper initialTab="news_etc" initialArticles={initialArticles} initialAuthorName={authorMatch} initialKeyword={keywordMatch} authorProfile={authorProfile} />;
}
