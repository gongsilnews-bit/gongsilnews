...
export default async function MobileHomePage() {
  const [
    ...
    getArticles({ status: "APPROVED", section1: "공실현장", limit: 30 }),
    getArticles({ status: "APPROVED", section1: "정책시장", limit: 6 }),
    getArticles({ status: "APPROVED", section1: "AI중개실무", limit: 6 }),
    getArticles({ status: "APPROVED", section1: "기타", limit: 6 }),
