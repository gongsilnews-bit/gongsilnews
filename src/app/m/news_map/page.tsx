...
export default async function MobileNewsPage({
  ...
  const filters: any = { status: "APPROVED", limit: 30, section1: "우리동네부동산" };
  ...
  return <MobileNewsClientWrapper initialTab="local" initialArticles={initialArticles} initialAuthorName={authorMatch} initialKeyword={keywordMatch} authorProfile={authorProfile} />;
}
