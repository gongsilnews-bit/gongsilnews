...
export default function MobileSignupPage() {
  ...
  const handleOAuthLogin = async (providerName: "google" | "kakao" | "naver") => {
    try {
      ...
      const returnTo = encodeURIComponent("/m");
  ...
  return (
    <div style={{ backgroundColor: "#fff", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <header style={{ display: "flex", alignItems: "center", padding: "0 16px", height: "56px", borderBottom: "1px solid #eee", position: "sticky", top: 0, background: "#fff", zIndex: 10 }}>
        <button onClick={() => router.back()} style={{ background: "none", border: "none", display: "flex", alignItems: "center", color: "#333", marginRight: "16px", padding: 0 }}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="15 18 9 12 15 6"></polyline>
          </svg>
        </button>
        <h1 style={{ fontSize: "17px", fontWeight: 800, margin: 0 }}>무료회원가입</h1>
      </header>
        ...
        {showFindAccount ? (
          <div style={{ width: "100%", maxWidth: "400px" }}>
            ...
            <input type="text" value={findName} onChange={e => setFindName(e.target.value)} placeholder="이름 입력"
              style={{ width: "100%", padding: "12px 14px", border: "1px solid #ddd", borderRadius: 6, fontSize: 14, marginBottom: 16, boxSizing: "border-box", outline: "none", fontFamily: "inherit" }} />
            ...
            <input type="tel" value={findPhone} onChange={e => {
              ...
              style={{ width: "100%", padding: "12px 14px", border: "1px solid #ddd", borderRadius: 6, fontSize: 14, marginBottom: 24, boxSizing: "border-box", outline: "none", fontFamily: "inherit" }} />

            <button onClick={handleFindAccount} disabled={findLoading}
              style={{ width: "100%", padding: "14px 0", background: "#1e56a0", color: "#fff", border: "none", borderRadius: 8, fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", marginBottom: 16 }}>
            ...
            <button onClick={() => { setShowFindAccount(false); setFindResult(null); }}
              style={{ width: "100%", padding: "12px 0", background: "none", border: "1px solid #ddd", borderRadius: 8, fontSize: 13, color: "#666", cursor: "pointer", fontFamily: "inherit" }}>
              ← 뒤로 돌아가기
            </button>
          </div>
        ) : (
          <div style={{ width: "100%", maxWidth: "400px", display: "flex", flexDirection: "column", alignItems: "center" }}>
            ...
            <p style={{ fontSize: 13, color: "#888", textAlign: "center", lineHeight: 1.6, margin: "0 0 26px 0", wordBreak: "keep-all" }}>
            ...
            <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <button onClick={() => handleOAuthLogin("google")}
                style={{ width: "100%", background: "#fff", border: "2px solid #4285F4", borderRadius: 8, padding: "14px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontWeight: "bold", fontSize: 15, color: "#222", boxShadow: "0 2px 8px rgba(66,133,244,0.15)", cursor: "pointer", fontFamily: "inherit", transition: "all 0.15s", position: "relative" }}
              >
                <span style={{ position: "absolute", top: -10, right: 14, background: "#4285F4", color: "#fff", fontSize: 10, fontWeight: 800, padding: "2px 8px", borderRadius: 10, letterSpacing: 0.5 }}>추천</span>
              ...
              <button onClick={() => handleOAuthLogin("kakao")}
                style={{ width: "100%", background: "#FEE500", border: "none", borderRadius: 8, padding: "14px 0", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontWeight: "bold", fontSize: 15, color: "#000", cursor: "pointer", fontFamily: "inherit" }}
              >
            ...
            <button onClick={() => { setShowFindAccount(true); setFindResult(null); }}
              style={{ marginTop: 24, background: "none", border: "none", fontSize: 13, color: "#999", cursor: "pointer", fontFamily: "inherit", padding: "8px" }}
            >
              어떤 계정으로 가입했는지 모르시나요?
            </button>
          </div>
