    ...
    >
      ...
      {!showDetail && (
        <>
          ...
          {/* 지도 페이지일 때 -> 리스트보기 버튼 (목록 화면의 지도보기 버튼과 반대 역할) */}
          {activeTab === 'local' && !showListPanel && (
            <Link
              href="/m/news"
              style={{
                position: "fixed",
                ...
                justifyContent: "center",
                gap: "7px",
                boxShadow: "0 6px 16px rgba(26, 46, 80, 0.4)",
                zIndex: 9998,
                cursor: "pointer",
                border: "none",
                outline: "none",
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ userSelect: "none" }}>
                <line x1="8" y1="6" x2="21" y2="6"></line>
                <line x1="8" y1="12" x2="21" y2="12"></line>
                <line x1="8" y1="18" x2="21" y2="18"></line>
                <line x1="3" y1="6" x2="3.01" y2="6"></line>
              ...
              <span style={{ fontSize: "14px", fontWeight: 800 }}>리스트보기</span>
            </Link>
          )}
