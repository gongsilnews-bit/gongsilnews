    ...
    <>
      ...
      <div 
        ...
        style={{
          ...
          opacity: Math.max(0, 1 - translateX / 300), transition: translateX === 0 ? 'opacity 0.3s' : 'none'
        }} 
      />
      ...
      <div 
        ...
        style={{
          ...
          transform: `translateX(${translateX > 0 ? translateX : 0}px)`,
