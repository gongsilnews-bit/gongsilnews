        ...
        {recentSearches.length > 0 ? (
          <>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <h3 style={{ fontSize: '15px', fontWeight: 700, color: '#111' }}>ìµœê·¼ ê²€?‰ì–´</h3>
              <button onClick={clearAllRecent} style={{ fontSize: '13px', color: '#999', background: 'none', border: 'none', cursor: 'pointer' }}>?„ì²´?? œ</button>
            </div>
            <div>
