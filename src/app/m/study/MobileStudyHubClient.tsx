...
const BOARD_ITEMS = [
  { id: "drone", name: "드론영상", desc: "매물 홍보용 드론 항공 촬영 영상", icon: "🎬" },
  { id: "app", name: "APP(앱)", desc: "부동산 업무에 유용한 앱 모음", icon: "📱" },
  { id: "prompt", name: "AI 프롬프트", desc: "ChatGPT·AI 활용 프롬프트 공유", icon: "🤖" },
  { id: "sound", name: "음원", desc: "매물 영상용 배경 음원 자료", icon: "🎵" },
  { id: "doc", name: "계약서/양식", desc: "부동산 계약서 및 실무 양식", icon: "📄" },
];

const COMMUNITY_ITEMS = [
  { id: "free", name: "자유게시판", desc: "부동산인들의 자유로운 소통 공간", icon: "💬" },
  { id: "qna", name: "Q&A게시판", desc: "중개 실무 질문과 답변", icon: "❓" },
  { id: "notice", name: "공지사항", desc: "공실뉴스 공식 공지사항", icon: "📢" },
  { id: "inquiry", name: "1:1 문의", desc: "고객센터 1:1 문의하기", icon: "✉️" },
];
