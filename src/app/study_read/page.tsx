      ...
      <main className="w-[1200px] mx-auto px-[20px] pt-[30px] pb-[100px]">
        ...
        <div className="flex gap-[40px] relative">
          ...
          <div className="flex-[6.5] min-w-0">
             ...
             {/* Sticky Tab Menu */}
             <div className="sticky top-[82px] border-b border-[#eee] flex mb-[40px]" style={{ zIndex: 90, backgroundColor: "#ffffff" }}>
          ...
          <div className="flex-[3.5] min-w-0">
             <div className="sticky top-[100px] bg-white border border-[#e5e5e5] rounded-[12px] p-[32px] shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
