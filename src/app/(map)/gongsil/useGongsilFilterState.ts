...
export function useGongsilFilterState() {
  ...
  useMapFields("pc-gongsil-filters", { filterTradeTypes, tempFilterTradeTypes, tempMaemaeMin, tempMaemaeMax, tempDepositMin, tempDepositMax, tempRentMin, tempRentMax, filterAuctionDiscount, filterAuctionBidCount, filterAuctionStartDate, filterAuctionAppraisalMin, filterAuctionAppraisalMax, filterAuctionBidPriceMin, filterAuctionBidPriceMax, sliderInteractions, roomBathInteractions, appliedMaemaeMin, appliedMaemaeMax, appliedDepositMin, appliedDepositMax, appliedRentMin, appliedRentMax, popoverSearchKeyword, filterSearchKeyword, filterPriceMin, filterPriceMax, filterAreaMin, filterAreaMax, filterMaintIdx, filterRoomCount, filterBathCount, filterDirection, filterParking, filterYearMin, filterYearMax, filterUnitMin, filterUnitMax, filterFloor, filterSaleStage, filterSaleType, filterOptions, filterOwnerRole, filterCommissionType, filterThemes }, { filterTradeTypes: setFilterTradeTypes, tempFilterTradeTypes: setTempFilterTradeTypes, tempMaemaeMin: setTempMaemaeMin, tempMaemaeMax: setTempMaemaeMax, tempDepositMin: setTempDepositMin, tempDepositMax: setTempDepositMax, tempRentMin: setTempRentMin, tempRentMax: setTempRentMax, filterAuctionDiscount: setFilterAuctionDiscount, filterAuctionBidCount: setFilterAuctionBidCount, filterAuctionStartDate: setFilterAuctionStartDate, filterAuctionAppraisalMin: setFilterAuctionAppraisalMin, filterAuctionAppraisalMax: setFilterAuctionAppraisalMax, filterAuctionBidPriceMin: setFilterAuctionBidPriceMin, filterAuctionBidPriceMax: setFilterAuctionBidPriceMax, sliderInteractions: setSliderInteractions, roomBathInteractions: setRoomBathInteractions, appliedMaemaeMin: setAppliedMaemaeMin, appliedMaemaeMax: setAppliedMaemaeMax, appliedDepositMin: setAppliedDepositMin, appliedDepositMax: setAppliedDepositMax, appliedRentMin: setAppliedRentMin, appliedRentMax: setAppliedRentMax, popoverSearchKeyword: setPopoverSearchKeyword, filterSearchKeyword: setFilterSearchKeyword, filterPriceMin: setFilterPriceMin, filterPriceMax: setFilterPriceMax, filterAreaMin: setFilterAreaMin, filterAreaMax: setFilterAreaMax, filterMaintIdx: setFilterMaintIdx, filterRoomCount: setFilterRoomCount, filterBathCount: setFilterBathCount, filterDirection: setFilterDirection, filterParking: setFilterParking, filterYearMin: setFilterYearMin, filterYearMax: setFilterYearMax, filterUnitMin: setFilterUnitMin, filterUnitMax: setFilterUnitMax, filterFloor: setFilterFloor, filterSaleStage: setFilterSaleStage, filterSaleType: setFilterSaleType, filterOptions: setFilterOptions, filterOwnerRole: setFilterOwnerRole, filterCommissionType: setFilterCommissionType, filterThemes: setFilterThemes });
