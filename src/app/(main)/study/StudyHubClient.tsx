    ...
    <div style={{ backgroundColor: "#ffffff", fontFamily: "'Pretendard Variable', -apple-system, sans-serif", color: "#132e27", minHeight: "100vh" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexWrap: "wrap", gap: 30 }}>
            <div style={{ maxWidth: 720 }}>
              <h1 style={{ fontSize: "38px", fontWeight: 900, lineHeight: 1.3, letterSpacing: "-1px", margin: "0 0 16px 0" }}>
                ...
                <span style={{ color: "#34d399" }}>공실뉴스 AI 부동산 실전 스터디</span>
              </h1>
      ...
      {activeTab === "lecture" && (
        <>
          ...
          <section style={{ padding: "65px 0 60px", backgroundColor: "#f2f9f6", borderBottom: "1px solid #d1fae5" }}>
            <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px" }}>
              ...
              <div style={{ textAlign: "center", marginBottom: 44 }}>
                ...
                <h2 style={{ fontSize: "28px", fontWeight: 800, color: "#062828", margin: "8px 0 10px 0", letterSpacing: "-0.5px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                ...
                {/* 공실뉴스 1년 스터디 */}
                <div style={{ background: "#ffffff", border: "2px solid #059669", borderRadius: 14, padding: "28px 24px", boxShadow: "0 8px 24px rgba(5, 150, 105, 0.08)" }}>
                  <div style={{ display: "inline-block", background: "#ecfdf5", color: "#047857", fontSize: 12, fontWeight: 800, padding: "3px 10px", borderRadius: 6, marginBottom: 16 }}>
                    ✅ 공실뉴스 1년 스터디
                  </div>
                  <h3 style={{ fontSize: 17, fontWeight: 800, color: "#062828", margin: "0 0 14px 0" }}>365일 실전 동행 마스터마인드</h3>
                  <ul style={{ listStyle: "none", padding: 0, margin: 0, fontSize: 14, color: "#064e3b", fontWeight: 600, lineHeight: 1.9 }}>
          ...
          <section style={{ padding: "70px 0 65px", backgroundColor: "#ffffff", borderBottom: "1px solid #e2e8f0" }}>
            <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 18 }}>
                ...
                {/* STEP 1 */}
                <div style={{ background: "#f4fbf7", border: "1px solid #d1fae5", borderRadius: 12, padding: "22px 18px" }}>
                  <div style={{ fontSize: 12, fontWeight: 800, color: "#059669", marginBottom: 8 }}>Q1 (1~3개월차)</div>
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 10px 0" }}>🤖 AI 무기 장착기</h4>
                ...
                {/* STEP 2 */}
                <div style={{ background: "#f4fbf7", border: "1px solid #d1fae5", borderRadius: 12, padding: "22px 18px" }}>
                  <div style={{ fontSize: 12, fontWeight: 800, color: "#059669", marginBottom: 8 }}>Q2 (4~6개월차)</div>
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 10px 0" }}>🏢 실전 공실 해결기</h4>
                  <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.55, margin: 0 }}>
                ...
                {/* STEP 3 */}
                <div style={{ background: "#f4fbf7", border: "1px solid #d1fae5", borderRadius: 12, padding: "22px 18px" }}>
                  <div style={{ fontSize: 12, fontWeight: 800, color: "#059669", marginBottom: 8 }}>Q3 (7~9개월차)</div>
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 10px 0" }}>🔨 경공매 & 수익 극대화</h4>
                  <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.55, margin: 0 }}>
                    · 법원 경·공매 권리분석 실전<br />
                    · 돈 되는 유찰 물건 정밀 발굴<br />
                    · 특수물건 중개 및 절세 세무 전략
                ...
                {/* STEP 4 */}
                <div style={{ background: "#f4fbf7", border: "1px solid #d1fae5", borderRadius: 12, padding: "22px 18px" }}>
                  <div style={{ fontSize: 12, fontWeight: 800, color: "#059669", marginBottom: 8 }}>Q4 (10~12개월차)</div>
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 10px 0" }}>🏆 지역 1등 브랜드 안착</h4>
                  <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.55, margin: 0 }}>
          ...
          <section style={{ padding: "65px 0", backgroundColor: "#f2f9f6", borderBottom: "1px solid #d1fae5" }}>
            <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 24px" }}>
              ...
              <div style={{ textAlign: "center", marginBottom: 40 }}>
                ...
                <h2 style={{ fontSize: "28px", fontWeight: 800, color: "#062828", margin: "8px 0 0 0", letterSpacing: "-0.5px" }}>
                  1년 스터디 멤버십 4대 핵심 혜택
                </h2>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 20 }}>
                ...
                <div style={{ background: "#ffffff", padding: "24px 20px", borderRadius: 12, border: "1px solid #d1fae5" }}>
                  <div style={{ width: 44, height: 44, borderRadius: 10, background: "#ecfdf5", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, marginBottom: 16 }}>
                    🎬
                  </div>
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 6px 0" }}>365일 무제한 VOD</h4>
                ...
                <div style={{ background: "#ffffff", padding: "24px 20px", borderRadius: 12, border: "1px solid #d1fae5" }}>
                  ...
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 6px 0" }}>매월 신규 실무 업데이트</h4>
                  <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.5, margin: 0 }}>
                ...
                <div style={{ background: "#ffffff", padding: "24px 20px", borderRadius: 12, border: "1px solid #d1fae5" }}>
                  ...
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 6px 0" }}>실무 서식 원본 제공</h4>
                  <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.5, margin: 0 }}>
                ...
                <div style={{ background: "#ffffff", padding: "24px 20px", borderRadius: 12, border: "1px solid #d1fae5" }}>
                  ...
                  <h4 style={{ fontSize: 16, fontWeight: 800, color: "#062828", margin: "0 0 6px 0" }}>전국 스터디 크루 연계</h4>
                  <p style={{ fontSize: 13, color: "#475569", lineHeight: 1.5, margin: 0 }}>
                      ...
                      >
                        <div
                          ...
                          onMouseEnter={(e) => {
                            ...
                            e.currentTarget.style.boxShadow = "0 10px 20px rgba(5, 150, 105, 0.08)";
                        ...
                        >
                          ...
                          <div style={{ padding: "16px", flex: 1, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                            <div>
                              <span style={{ fontSize: 11.5, fontWeight: 700, color: "#047857", background: "#ecfdf5", padding: "2px 7px", borderRadius: 4, display: "inline-block", marginBottom: 8 }}>
                                {item.category || "중개실무"}
                              </span>
                              <h3
                                style={{
                            ...
                            <div>
                              ...
                              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingTop: 10, borderTop: "1px solid #f1f5f9" }}>
                                <span style={{ fontSize: 15, fontWeight: 800, color: item.price ? "#062828" : "#059669" }}>
