          ...
          <div className="w-[340px] shrink-0">
            <div className="sticky top-[110px] bg-white border border-[#e5e5e5] rounded-[12px] p-[28px] shadow-[0_12px_40px_rgba(0,0,0,0.08)]">
              ...
              <div className="flex flex-col gap-[10px]">
                <button onClick={() => router.push(`/study_watch?id=${lecture.id}`)} style={{ width: "100%", padding: "18px 0", borderRadius: 6, fontSize: 16, fontWeight: 800, color: "#fff", border: "none", cursor: "pointer", background: "linear-gradient(135deg, #f59e0b, #d97706)", boxShadow: "0 4px 14px rgba(245,158,11,0.35)", transition: "all 0.2s" }} onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-1px)"; e.currentTarget.style.boxShadow = "0 6px 20px rgba(245,158,11,0.45)"; }} onMouseLeave={(e) => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 4px 14px rgba(245,158,11,0.35)"; }}>🚀 클래스 수강 시작하기</button>
