      ...
      <main className="w-full px-4 md:px-6" style={{ maxWidth: 1200, margin: "0 auto", paddingBottom: 120, paddingTop: 40 }}>
        ...
        <div className="flex flex-col lg:flex-row relative" style={{ gap: 48, alignItems: "stretch" }}>
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Sticky Tab */}
            <div className="sticky bg-white z-50 flex border-b transition-colors" style={{ position: "sticky", top: 101, borderColor: "#f0f0f0", marginBottom: 48 }}>
            ...
            <div className="sticky" style={{ position: "sticky", top: 180 }}>
              ...
              <div className="flex flex-col" style={{ gap: 14 }}>
                <div className="flex items-center font-medium" style={{ gap: 12, fontSize: 14, color: "#3e4042" }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><polygon points="23 7 16 12 23 17 23 7"></polygon><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect></svg>
                  {totalLessons}개 강의 {lecture.total_duration ? `(총 ${lecture.total_duration})` : ""}
                </div>
                <div className="flex items-center font-medium" style={{ gap: 12, fontSize: 14, color: "#3e4042" }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                  수업 노트 및 PDF 교재 제공
                </div>
                <div className="flex items-center font-medium" style={{ gap: 12, fontSize: 14, color: "#3e4042" }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                  크리에이터 Q&A 및 피드백
                </div>
                <div className="flex items-center font-medium" style={{ gap: 12, fontSize: 14, color: "#3e4042" }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                  결제 후 {lecture.duration_months || 5}개월 무제한 수강
                </div>
              </div>
